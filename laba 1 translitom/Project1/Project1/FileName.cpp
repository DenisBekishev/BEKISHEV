...
double* veñtorNevyazki(double** matrix_full, double* matrix_answers, double* answers, int n) {
...
int main() {
	...
	cout << "Enter the size of matrix" << endl << "n = ";
	int n;
	cin >> n;
	cout << endl;
	...
	double* vectorNevyaz = veñtorNevyazki(matrix_full_copy, matrix_answers_copy, answers, n);
	for (int i = 0; i < n; i++) {
		cout << vectorNevyaz[i] << " ";
	}
	...
	cout << endl << "Norma nevyazki: " << norma << endl;
	...
	cout << endl << "Pogreshnost: " << pogreshnost(answers, new_answers, n);
